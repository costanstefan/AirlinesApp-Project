...
CREATE TABLE `cancellations` (
  ...
  `flight_date` varchar(45) NOT NULL,
  PRIMARY KEY (`cancellation_ID`),
  UNIQUE KEY `idnew_table_UNIQUE` (`cancellation_ID`)
...
INSERT INTO `cancellations` VALUES (1,'1','1','2022-08-04'),(2,'3','2','2022-09-17'),(3,'2','123','2022-01-01');
